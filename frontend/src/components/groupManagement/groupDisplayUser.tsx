...
import { makeStyles, Theme, createStyles, unstable_createMuiStrictModeTheme } from '@material-ui/core/styles';
...
export const GroupDisplayUser = ( props: {groups : Groups, users: User[]}) => {
